...
/// use seagull_vipers::validate_derived_address;
...
///   &expected, &seagull_vipers::ID, seeds
/// ));
/// assert!(!validate_derived_address(
///   &solana_program::system_program::ID, &seagull_vipers::ID, seeds
/// ));
/// ```
...
pub mod prelude {
    //! The prelude contains all commonly used components of the crate. All programs should include it via `use seagull_vipers::prelude::*;`.
